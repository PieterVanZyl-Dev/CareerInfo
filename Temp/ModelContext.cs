...
namespace CareerInfo.Temp
{
    public partial class ModelContext : DbContext
    {
        ...
        public virtual DbSet<Favouritejobs> Favouritejobs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Favouritejobs>(entity =>
            {
                entity.HasKey(e => e.Favouriteid);

                entity.ToTable("FAVOURITEJOBS");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.Favouritejobs)
                    .HasForeignKey(d => d.Userid)
                    .HasConstraintName("USERID");
            });

            modelBuilder.HasSequence("ISEQ$$_57047");
        }
    }
}
